...
class Example(BaseModel):
    name: Optional[str] = Field(description="Name of the example",
                                example="John Doe", default="John Doe", alias="full_name")
    ...
    entry: Optional[List[Dict[str, str]]] = Field(
        description="Properties of the example")
    created_at: datetime.datetime = Field(
        description="Creation date of the example", default="datetime.datetime.now()", required="True")

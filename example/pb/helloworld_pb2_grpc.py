...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GEEDelete = channel.unary_unary(
                '/helloworld.Greeter/GEEDelete',
                request_serializer=helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.HelloReply.FromString,
                _registered_method=True)
        ...
        self.Health = channel.unary_unary(
                '/helloworld.Greeter/Health',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=helloworld__pb2.HealthResponse.FromString,
                _registered_method=True)
        self.AuthCheck = channel.unary_unary(
                '/helloworld.Greeter/AuthCheck',
                request_serializer=helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.HelloReply.FromString,
                _registered_method=True)
...
class GreeterServicer(object):
    ...
    def GEEDelete(self, request, context):
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GEEDelete': grpc.unary_unary_rpc_method_handler(
                    servicer.GEEDelete,
                    request_deserializer=helloworld__pb2.HelloRequest.FromString,
                    response_serializer=helloworld__pb2.HelloReply.SerializeToString,
            ),
            ...
            'Health': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=helloworld__pb2.HealthResponse.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            helloworld__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

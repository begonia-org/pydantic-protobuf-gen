...
class Example(_message.Message):
    __slots__ = ("name", "age", "emails", "examples", "entry", "nested", "created_at", "type", "score", "metadatas", "embeddings")
